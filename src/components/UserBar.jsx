...
export default function UserBar({ profile, onSignOut, onRecharge, onHistorique, onDeploiements }) {
  ...
  return (
    <div style={{ background: '#1A1A1A', color: '#fff', padding: '8px 24px', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 8, fontSize: 13 }}>
      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 12, rowGap: 4 }}>
